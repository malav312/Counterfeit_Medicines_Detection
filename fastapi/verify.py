...
def comparision_metric(input_image_json_path, medicine_name):
    ...
    for json in image_path_list:
        print("json",json)
        print("input_image_json_path",input_image_json_path)
...
def authentication(image_path,directory):
    json_path = toJson(image_path)
    return comparision_metric(json_path,directory)

# authentication("../Data_Augmentation/Accept-SP_Tablet2 (1).jpg","Accept-SP_Tablet")
